...
export interface Tenant {
  id: string;
  /**
   * The name of the store that will be displayed to users.
   */
  name: string;
  /**
  ...
  slug: string;
  /**
   * The logo of the store that will be displayed to users.
   */
  logo?: (string | null) | Media;
  description?: string | null;
  /**
   * The Stripe account ID associated with the store.
   */
...
export interface Product {
  ...
  /**
   * Mark this product as archived / hidden from the public.
   */
