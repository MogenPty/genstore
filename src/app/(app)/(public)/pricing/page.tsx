...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! We offer a 14-day free trial for all plans. No credit card required to start your trial. You can explore all features and decide which plan works best for you.",
  },
  {
    question: "What happens if I exceed my plan limits?",
    answer:
      "We'll notify you when you're approaching your limits. You can either upgrade your plan or we'll work with you to find the best solution for your needs.",
  },
  {
    question: "Do you offer discounts for annual billing?",
    answer:
      "Yes! Save 20% when you choose annual billing. This discount is automatically applied when you select the annual billing option during checkout.",
  },
  {
...
const testimonials = [
  {
    quote:
      "The Professional plan has been perfect for our growing team. The advanced analytics have helped us make better decisions.",
  ...
  {
    quote:
      "Enterprise features and support are outstanding. The dedicated account manager has been incredibly helpful.",
    author: "Michael Chen",
    role: "CTO",
          ...
          <Card className="p-12 bg-gradient-to-r from-primary/5 to-secondary/5">
            <CardContent className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Start your free trial today and see why thousands of teams
                choose our platform.
              </p>
